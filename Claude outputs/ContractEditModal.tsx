...
/**
 * Modal para editar los campos de un contrato laboral.
 * Ruta: src/modules/hr/components/ContractEditModal.tsx
 */
...
import type { ContractRow } from "@/modules/hr/types";
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await updateContractAction({
        ...
        contractType: fields.contractType as import("@/modules/hr/types").ContractType,
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 space-y-4">
          ...
          <label className="flex items-center gap-2 text-sm cursor-pointer">
            <input
              ...
              onChange={e => set("isFullTime", e.target.checked)}
              className="rounded"
            />
            Jornada completa
          </label>
